...
def train(args: Dict):
    ...
    """
    train_data_src = read_corpus(args['--train-src'], source='src')  # the spanish corpus (216617)
    train_data_tgt = read_corpus(args['--train-tgt'], source='tgt')  # the english corpus (216617)

    # DATA CONFIGuRATION (depends on the params)
    ...
    # VARIABLE INITIALIZATION FROM PARAMETERS
...
def decode(args: Dict[str, str]):
    ...
    hypotheses = beam_search_word2vec_id(model, test_data_src,
