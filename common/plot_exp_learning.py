...
if __name__ == '__main__':
    ...
    # retrieve loss
    df = pandas.read_csv(str(path)+"learning_symbolicTransformer_french_23-05-24_A2.csv")
    ...
    plt.savefig('img/learning_curves_ST_2023-05-24_A2.png')
    plt.show()
